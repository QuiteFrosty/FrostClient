...
import dev.frostclient.helpers.ColorHelper;
...
public class Helper2D {
    ...
    public static void drawPicture(int x, int y, int w, int h, int color, String location) {
        ...
        ResourceLocation resourceLocation = new ResourceLocation(Frost.modID, location);
        Frost.INSTANCE.mc.getTextureManager().bindTexture(resourceLocation);
