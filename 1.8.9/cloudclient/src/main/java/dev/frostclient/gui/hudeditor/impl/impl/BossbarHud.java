...
public class BossbarHud extends HudMod {
    ...
    private void renderBossHealth() {
        ...
        Frost.INSTANCE.mc.getTextureManager().bindTexture(Gui.icons);
        ...
        Frost.INSTANCE.mc.fontRendererObj.drawStringWithShadow(s, x + width / 2f - Frost.INSTANCE.mc.fontRendererObj.getStringWidth(s) / 2f, y, 16777215);
