        ...
        if (Frost.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Frost.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - Frost.INSTANCE.fontHelper.size20.getStringWidth("FPS: " + Minecraft.getDebugFPS()) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Frost.INSTANCE.mc.fontRendererObj.drawString(
                        "FPS: " + Minecraft.getDebugFPS(),
                        getX() + getW() / 2 - Frost.INSTANCE.mc.fontRendererObj.getStringWidth("FPS: " + Minecraft.getDebugFPS()) / 2,
                        getY() + 6,
                        getColor()
                );
            }
