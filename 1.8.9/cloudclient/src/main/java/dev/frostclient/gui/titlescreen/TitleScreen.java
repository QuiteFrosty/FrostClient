...
package dev.frostclient.gui.titlescreen;

import dev.frostclient.Frost;
import dev.frostclient.gui.titlescreen.buttons.IconButton;
import dev.frostclient.gui.titlescreen.buttons.TextButton;
import dev.frostclient.helpers.font.GlyphPageFontRenderer;
...
public class TitleScreen extends Panorama {
    ...
    /**
     * Draws the main "Frost" Text and the Logo in the middle
     */

    private void drawLogo() {
        GlyphPageFontRenderer fontRenderer = Frost.INSTANCE.fontHelper.size40;
        fontRenderer.drawString("Frost Client", width / 2f - fontRenderer.getStringWidth("Frost Client") / 2f, height / 2f - 27.5f, -1);
        Helper2D.drawPicture(width / 2 - 30, height / 2 - 98, 60, 60, -1, "frostlogo.png");
    }

    /**
     * Draws the "Frost Client" Text and Mojang Copyright Notice on the bottom
     */

    private void drawCopyright() {
        GlyphPageFontRenderer fontRenderer = Frost.INSTANCE.fontHelper.size20;
        String copyright = "Copyright Mojang Studios. Do not distribute!";
        String text = "Frost Client " + Frost.modVersion;
