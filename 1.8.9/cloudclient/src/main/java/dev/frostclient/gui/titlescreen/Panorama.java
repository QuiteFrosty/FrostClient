...
public class Panorama extends GuiScreen {
    ...
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[]{
            new ResourceLocation(Frost.modID, "panorama/panorama_0.png"),
            new ResourceLocation(Frost.modID, "panorama/panorama_1.png"),
            new ResourceLocation(Frost.modID, "panorama/panorama_2.png"),
            new ResourceLocation(Frost.modID, "panorama/panorama_3.png"),
            new ResourceLocation(Frost.modID, "panorama/panorama_4.png"),
            new ResourceLocation(Frost.modID, "panorama/panorama_5.png")
    };
