...
import dev.frostclient.helpers.*;
...
public class ColorPicker extends Settings {
    ...
    public void renderSetting(int mouseX, int mouseY) {
        ...
        boolean rounded = Frost.INSTANCE.optionManager.getOptionByName("Rounded Corners").isCheckToggled();
        int color = Frost.INSTANCE.optionManager.getOptionByName("Color").getColor().getRGB();

        Frost.INSTANCE.fontHelper.size30.drawString(setting.getName(), button.getPanel().getX() + 20, getYH + 6, color);
        animate.update();
        ...
        Frost.INSTANCE.fontHelper.size20.drawString(rgbText, getXW - 45 - Frost.INSTANCE.fontHelper.size20.getStringWidth(rgbText), getYH + 9, -1);
