...
package dev.frostclient.gui.hudeditor.impl;
...
public abstract class HudMod {
    ...
    public void renderMod(int mouseX, int mouseY) {
        if (withinMod(mouseX, mouseY) || isDragging()) {
            ...
            Frost.INSTANCE.fontHelper.size20.drawString("Size: " + MathHelper.round(getSize(), 1),
                    getX() + getW() / 2f - Frost.INSTANCE.fontHelper.size20.getStringWidth("Size: " + MathHelper.round(getSize(), 1)) / 2f,
                    getY() + getH() + 10, -1
            );
        }
    }
