    ...
    public void renderMod(int mouseX, int mouseY) {
        ...
        if (Frost.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                FontHelper fontHelper = Frost.INSTANCE.fontHelper;

                int value = (int) normalized(Frost.INSTANCE.mc.thePlayer.rotationYaw);
                ...
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Frost.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 86);
                    int xHalf = (int) ((normalized(Frost.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 43);
                ...
                FontRenderer fontHelper = Frost.INSTANCE.mc.fontRendererObj;
                ...
                GLHelper.startScissor(getX(), getY(), (int) (getW() * getSize()), (int) (getH() * getSize()));
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Frost.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 83);
                    int xHalf = (int) ((normalized(Frost.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 40);
