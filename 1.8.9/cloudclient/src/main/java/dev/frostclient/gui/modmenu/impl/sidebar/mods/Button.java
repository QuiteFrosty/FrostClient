...
package dev.frostclient.gui.modmenu.impl.sidebar.mods;
...
import dev.frostclient.gui.modmenu.impl.sidebar.mods.impl.type.*;
...
public class Button {
    ...
    public Button(Mod mod, Panel panel, int x, int y) {
        ...
        if (Frost.INSTANCE.settingManager.getSettingsByMod(mod) != null) {
            int addY = 70;
            for (Setting setting : Frost.INSTANCE.settingManager.getSettingsByMod(mod)) {
    ...
    public void renderButton(int mouseX, int mouseY) {
        ...
        if (!getPanel().isAnyButtonOpen()) {
            ...
            Frost.INSTANCE.fontHelper.size20.drawString(mod.getName(), panel.getX() + 10 + x, panel.getY() + panel.getH() + y + 97, color);
        ...
        if (open) {
            ...
            Frost.INSTANCE.fontHelper.size30.drawString(mod.getName(), panel.getX() + 5 + 7, panel.getY() + panel.getH() + 5 + 8 + 300 - animPanel.getValueI(), color);
            Frost.INSTANCE.fontHelper.size20.drawString(mod.getDescription(), panel.getX() + 20 + Frost.INSTANCE.fontHelper.size30.getStringWidth(mod.getName()), panel.getY() + panel.getH() + 316 - animPanel.getValueI(), color);
