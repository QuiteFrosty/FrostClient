package dev.frostclient.gui.modmenu.impl.sidebar;
...
public class TextBox {
    ...
    public void renderTextBox(int x, int y, int mouseX, int mouseY) {
        ...
        if(text.equals("")) {
            Frost.INSTANCE.fontHelper.size20.drawString(placeHolderText, x + offset + 20, y + offset + 6, 0x50ffffff);
        } else {
            Frost.INSTANCE.fontHelper.size20.drawString(text, x + offset + 20, y + offset + 6, -1);
            Helper2D.drawRectangle(x + offset + Frost.INSTANCE.fontHelper.size20.getStringWidth(text.substring(0, cursorPosition)) + 20, y + offset + 5, 1, 10, 0x80ffffff);
            if (allSelected) {
                Helper2D.drawRectangle(x + offset + 17, y + offset + 3, Frost.INSTANCE.fontHelper.size20.getStringWidth(text) + 4, 14, 0x503030ff);
            }
        }
        GLHelper.endScissor();
    }
