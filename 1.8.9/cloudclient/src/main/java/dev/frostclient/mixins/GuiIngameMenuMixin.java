...
public abstract class GuiIngameMenuMixin extends GuiScreen {
    ...
    /**
     * @author duplicat
     * @reason add Frost Button to Game menu
     */
    @Overwrite
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(31, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, "Frost Client"));
    ...
    /**
     * @author duplicat
     * @reason make frost button load menu
     */
    @Overwrite
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 30:
                ...
                break;
            case 31:
                this.mc.displayGuiScreen(Frost.INSTANCE.hudEditor);
                break;
        }
    }
}
