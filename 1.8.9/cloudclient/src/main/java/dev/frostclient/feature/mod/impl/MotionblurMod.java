...
public class MotionblurMod extends Mod {
    ...
    public MotionblurMod() {
        ...
        Frost.INSTANCE.settingManager.addSetting(new Setting("Amount", this, 10, 6));
    }
    ...
    public void renderOverlay(RenderGameOverlayEvent.Post event) {
        if (Frost.INSTANCE.mc.currentScreen == null) {
            if (event.type == RenderGameOverlayEvent.ElementType.ALL) {
                if (OpenGlHelper.isFramebufferEnabled()) {
                    int width = Frost.INSTANCE.mc.getFramebuffer().framebufferWidth;
                    int height = Frost.INSTANCE.mc.getFramebuffer().framebufferHeight;
                    ...
                    Frost.INSTANCE.mc.getFramebuffer().bindFramebufferTexture();
                    ...
                    Frost.INSTANCE.mc.getFramebuffer().bindFramebuffer(true);
    ...
    private float getAmount() {
        return Frost.INSTANCE.settingManager.getSettingByModAndName(getName(), "Amount").getCurrentNumber();
    }
}
